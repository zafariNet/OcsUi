$(function () {
    ...
    $(document).scroll(function(event){
      ...
      if(top>170)
      {
        ...
        $("#action-button-inner").find('a').removeClass('click-post-action-button');
        $("#action-button-inner").find('a').css('padding','5px 5px')
        $("#action-button-inner").find('a').addClass('click-post-action-button-scrolled')
        ...
        $("#action-button-inner").find('a').removeClass('click-post-action-button-scrolled')
