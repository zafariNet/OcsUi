...
export interface IAccountService {
    ...
    isTokenValid(tokenPath: string, tokenQuery?: string | null | undefined): Observable<ResultOfBoolean>;
}
...
export class AccountService implements IAccountService {
    ...
    isTokenValid(tokenPath: string, tokenQuery?: string | null | undefined): Observable<ResultOfBoolean> {
        ...
        if (tokenPath === undefined || tokenPath === null)
            throw new Error("The parameter 'tokenPath' must be defined.");
        url_ = url_.replace("{token}", encodeURIComponent("" + tokenPath));
        if (tokenQuery !== undefined && tokenQuery !== null)
            url_ += "token=" + encodeURIComponent("" + tokenQuery) + "&";
        url_ = url_.replace(/[?&]$/, "");
