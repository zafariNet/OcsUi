...
export interface IUserService {
    ...
    getAllUsers(filtering?: string | null | undefined, page?: number | undefined, pageSize?: number | undefined, sorting?: string | null | undefined): Observable<ResultOfPagedResultOfUserCompleteViewModel>;
}
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<ResultOfPagedResultOfUserCompleteViewModel>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ResultOfPagedResultOfUserCompleteViewModel>;
        }));
    }

    protected processGetAllUsers(response: HttpResponseBase): Observable<ResultOfPagedResultOfUserCompleteViewModel> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ResultOfPagedResultOfUserCompleteViewModel.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ResultOfPagedResultOfUserCompleteViewModel>(null as any);
    }
}
...
export class ResultOfPagedResultOfUserCompleteViewModel extends Result implements IResultOfPagedResultOfUserCompleteViewModel {
    value?: PagedResultOfUserCompleteViewModel | undefined;

    constructor(data?: IResultOfPagedResultOfUserCompleteViewModel) {
        super(data);
    }
    ...
    override init(_data?: any) {
        super.init(_data);
        if (_data) {
            this.value = _data["value"] ? PagedResultOfUserCompleteViewModel.fromJS(_data["value"]) : <any>undefined;
        }
    }

    static override fromJS(data: any): ResultOfPagedResultOfUserCompleteViewModel {
        data = typeof data === 'object' ? data : {};
        let result = new ResultOfPagedResultOfUserCompleteViewModel();
        result.init(data);
        return result;
    }
...
export interface IResultOfPagedResultOfUserCompleteViewModel extends IResult {
    value?: PagedResultOfUserCompleteViewModel | undefined;
}

export class PagedResultOfUserCompleteViewModel implements IPagedResultOfUserCompleteViewModel {
    itemList?: UserCompleteViewModel[] | undefined;
    totalCount?: number;
    page?: number;
    pageSize?: number;

    constructor(data?: IPagedResultOfUserCompleteViewModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["itemList"])) {
                ...
                for (let item of _data["itemList"])
                    this.itemList!.push(UserCompleteViewModel.fromJS(item));
            }
    ...
    static fromJS(data: any): PagedResultOfUserCompleteViewModel {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultOfUserCompleteViewModel();
        result.init(data);
        return result;
    }
...
export interface IPagedResultOfUserCompleteViewModel {
    itemList?: UserCompleteViewModel[] | undefined;
    totalCount?: number;
    page?: number;
    pageSize?: number;
...
export class UserCompleteViewModel implements IUserCompleteViewModel {
    id?: string;
    userName?: string | undefined;
    password?: string | undefined;
    normalizedUserName?: string | undefined;
    ...
    lastLoggedIn?: Date | undefined;
    parentUser?: UserCompleteViewModel | undefined;
    parentUserId?: string | undefined;
    childs?: UserCompleteViewModel[] | undefined;
    version?: string | undefined;

    constructor(data?: IUserCompleteViewModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.lastLoggedIn = _data["lastLoggedIn"] ? new Date(_data["lastLoggedIn"].toString()) : <any>undefined;
            this.parentUser = _data["parentUser"] ? UserCompleteViewModel.fromJS(_data["parentUser"]) : <any>undefined;
            this.parentUserId = _data["parentUserId"];
            if (Array.isArray(_data["childs"])) {
                this.childs = [] as any;
                for (let item of _data["childs"])
                    this.childs!.push(UserCompleteViewModel.fromJS(item));
            }
            this.version = _data["version"];
        }
    }

    static fromJS(data: any): UserCompleteViewModel {
        data = typeof data === 'object' ? data : {};
        let result = new UserCompleteViewModel();
        result.init(data);
        return result;
    }
...
export interface IUserCompleteViewModel {
    id?: string;
    userName?: string | undefined;
    password?: string | undefined;
    normalizedUserName?: string | undefined;
